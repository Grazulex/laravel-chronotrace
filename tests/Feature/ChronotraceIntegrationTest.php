...
it('has correct application environment setup', function (): void {
    /** @var Tests\TestCase $this */
    expect($this->getApp()->environment())->toBe('testing');
