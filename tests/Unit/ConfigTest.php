...
it('has a valid default configuration', function () {
...
it('has valid mode values', function () {
    $configPath = __DIR__.'/../../config/chronotrace.php';
...
it('has valid sample rate', function () {
    $configPath = __DIR__.'/../../config/chronotrace.php';
    /** @var array<string, mixed> $config */
    $config = include $configPath;
...
it('has valid retention days', function () {
    $configPath = __DIR__.'/../../config/chronotrace.php';
    /** @var array<string, mixed> $config */
    $config = include $configPath;
...
it('has valid scrub array', function () {
    $configPath = __DIR__.'/../../config/chronotrace.php';
    /** @var array<string, mixed> $config */
    $config = include $configPath;
